...
npm install -g --unsafe-perm node-gyp homebridge hap-nodejs json homebridge-server
cd ~/.npm-global/lib/node_modules/homebridge
npm install --unsafe-perm bignum
cd -
cd ~/.npm-global/lib/node_modules/hap-nodejs/node_modules/mdns
